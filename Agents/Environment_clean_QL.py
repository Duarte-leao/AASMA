...
class CleaningEnvQL(gym.Env):

    def __init__(self, grid_size, num_robots, max_episode_steps):

        super(CleaningEnvQL, self).__init__()
    ...
    def step(self, actions):
        ...
        if (self.num_dirt1 + self.num_dirt2) == 0:
            done = True
    ...
    def generate_dirt(self):
        ...
        self.num_dirt1 = np.random.randint(pow(self.grid_size,2)*0.10, pow(self.grid_size,2)*0.15)  # Randomly select the number of dirt squares
