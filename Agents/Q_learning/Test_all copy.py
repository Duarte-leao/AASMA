...
from Agents.Environment_clean_QL import CleaningEnvQL
from Agents.Environment_clean_Reactive import CleaningEnv
from Agents_reactive_0 import Reactive_0
...
if __name__ == '__main__':
    ...
    # 2 - Setup agents
    agents = [
        Reactive_0(n_robots, n_actions=6),
    ...
    for i, agent in enumerate (agents):
        ...
        if i !=4:
            result_t = run_agent( agent, n_episodes, grid_size, n_robots, max_steps)
            results_time[i] = result_t
        else:
            result_t = run_agent_Ql(agent, n_episodes, grid_size, n_robots, max_steps)
            results_time[i] = result_t
